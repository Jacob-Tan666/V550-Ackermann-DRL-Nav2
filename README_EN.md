...
robot, combining deep reinforcement learning (TD3) with a production-style
...
**Search keywords:** V550 Ackermann autonomous navigation, ROS 2 Humble, Nav2,
TD3 deep reinforcement learning, Gazebo robot simulation, Ackermann steering,
industrial warehouse navigation, dynamic obstacle avoidance.
...
|-- docs/assets/                       Architecture and presentation assets
|-- src/
|   |-- drl_navigation_ros2/           Environment, TD3, replay, train/test code
...
For development, tests, and linting, install the optional dependency groups:
...
| `DYNAMIC_OBSTACLES` | `true` (industrial mode) | Enable warehouse moving traffic |
...
Run Python formatting and static checks:
