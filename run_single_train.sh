...
echo "=========================================================="
echo "[INFO] 准备启动 1 个 Gazebo 仿真环境并运行单进程训练..."
echo "=========================================================="
echo "[INFO] Gazebo 日志: $GAZEBO_LOG_FILE"
echo "[INFO] 训练日志: $TRAIN_LOG_FILE"
...
GAZEBO_PID=$!
echo "[INFO] Gazebo 已拉起，PID: $GAZEBO_PID"
...
echo "[INFO] Gazebo 服务和机器人传感器已就绪。"

echo "[INFO] 开始执行单进程训练脚本..."
